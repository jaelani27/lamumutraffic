...
export default function Game() {
  ...
  // ===== Hitbox shrink (biar pas dengan bodi mobil) =====
  // 0.75 artinya lebar hitbox = 75% dari lebar sprite (kiri/kanan disunat),
  // 0.80 artinya tinggi hitbox = 80% dari tinggi sprite (atas/bawah disunat).
  const HITBOX_SHRINK_X = 0.75;
  const HITBOX_SHRINK_Y = 0.80;

  // Optional: kecilkan hitbox cone sedikit biar fair
  ...
  // ===== Collision dengan hitbox yang dikecilkan =====
  ...
  useEffect(() => {
    ...
    // arm audio sesudah interaksi pertama (mobile)
    const armAudio = () => {
